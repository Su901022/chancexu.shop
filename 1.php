<?php    
  ...
  $mysex=$_REQUEST["member_sex"];
  $myemail=$_REQUEST["member_email"];
  $mybirthday=$_REQUEST["member_birthday"];
...
$sql = "INSERT INTO member (`member_name`, `member_password`,`member_sex`, `member_email`, `member_birthday`) VALUES ('?','?','?','?','?')";
print($sql);
